...
{
  AnaroutePy router = AnaroutePy();

  router.setCircuitName("INVX12LVT");
  router.parseLef("../mockPDK/mock.lef");
  router.parseTechfile("../mockPDK/mock.techfile");
  router.parseGds("../INVX12LVT.place.gds");
